        ...
        <div className='blgpg3'>
            ...
            <div className="blogpage playwrite-fr-moderne-xyz" >
                <div id="grid" className="item">
                    <div className="blogpage-image"><img src=".\src\assets\blogimages\blog3.jpeg" alt="" /></div>
                    <div className="blogpage-title">MSME Sector in India: The Backbone of the Economy</div>
                </div>
