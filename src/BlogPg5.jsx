        ...
        <div className='blgpg5'>
            ...
            <div className="blogpage playwrite-fr-moderne-xyz" >
                <div id="grid" className="item">
                    <div className="blogpage-image"><img src=".\src\assets\blogimages\blog5.jpg" alt=""/></div>
                    <div className="blogpage-title">Property Insurance: Safeguarding Your Valuable Assets</div>
                </div>
